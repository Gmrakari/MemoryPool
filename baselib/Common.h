...
inline static void*& NEXT_OBJ(void* obj) {
	//抢取对象头四个或者八个字节，void*的别名，本省是内ucn，只能我们自己取
...
public:
	...
	//[129, 1024] //16bytes对其 freelist[15, 72)
	//[1025, 8 * 1024] 128位对其 freelist[72, 128)
	//[8 * 1024 + 1, 64 * 1024] 1024bytes 对齐 freelist[128, 184)
	...
	//动态计算从中心缓存分配多少个内存对象到TreadCache中
